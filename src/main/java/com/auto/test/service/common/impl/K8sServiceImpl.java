...
import com.auto.test.utils.MyJsonUtils;
        ...
        try {
          switch (apiversionTypeEnum) {
            case EXTENSION_API_V1BETA1:
              V1beta1CustomResourceDefinition v1beta1ApiCustomResourceDefinition = apiextensionsV1beta1Api.createCustomResourceDefinition(K8sUtils.toObject(k8SYamlDTO.getO(), V1beta1CustomResourceDefinition.class), CreateParam.pretty, CreateParam.dryRun, CreateParam.fieldManager);
              if (v1beta1ApiCustomResourceDefinition != null) {
                return true;
              }
            
            case EXTENSION_API_V1:
              V1CustomResourceDefinition v1CustomResourceDefinition = apiextensionsV1Api.createCustomResourceDefinition(K8sUtils.toObject(k8SYamlDTO.getO(), V1CustomResourceDefinition.class), CreateParam.pretty, CreateParam.dryRun, CreateParam.fieldManager);
            ...
            case STORAGE_K8S_IO_V1:
              ...
              V1StorageClass storageClass = storageV1Api.createStorageClass(K8sUtils.toObject(k8SYamlDTO.getO(), V1StorageClass.class), CreateParam.pretty, CreateParam.dryRun, CreateParam.fieldManager);
            ...
            case STORAGE_K8S_IO_V1BETA1:
              ...
              V1beta1StorageClass beta1StorageClass = storageV1beta1Api.createStorageClass(K8sUtils.toObject(k8SYamlDTO.getO(), V1beta1StorageClass.class), CreateParam.pretty, CreateParam.dryRun, CreateParam.fieldManager);
    ...
    if (rbacAuthorizationV1beta1Api != null) {
      switch (kindTypeEnum) {
        ...
        case CLUSTER_ROLE_BINDING:
          V1beta1ClusterRoleBinding clusterRoleBinding = rbacAuthorizationV1beta1Api.createClusterRoleBinding(K8sUtils.toObject(k8SYamlDTO.getO(), V1beta1ClusterRoleBinding.class), CreateParam.pretty, CreateParam.dryRun, CreateParam.fieldManager);
      ...
      switch (kindTypeEnum) {
        case NAMESPACE:
          V1Namespace v1Namespace = coreV1Api.createNamespace(
              K8sUtils.toObject(k8SYamlDTO.getO(), V1Namespace.class), CreateParam.pretty, CreateParam.dryRun, CreateParam.fieldManager);
          if (v1Namespace != null) {
            return true;
          }
          break;
        case POD:
          ...
          V1Pod v1Pod = coreV1Api.createNamespacedPod(k8SYamlDTO.getNamespace(),
              K8sUtils.toObject(k8SYamlDTO.getO(), V1Pod.class), CreateParam.pretty, CreateParam.dryRun, CreateParam.fieldManager);
          if (v1Pod != null) {
            return true;
          }
        ...
        case CONFIG_MAP:
          V1ConfigMap v1ConfigMap =
              coreV1Api.createNamespacedConfigMap(k8SYamlDTO.getNamespace(),
                  K8sUtils.toObject(k8SYamlDTO.getO(), V1ConfigMap.class), CreateParam.pretty, CreateParam.dryRun, CreateParam.fieldManager);
          if (v1ConfigMap != null) {
            return true;
          }
        ...
        case NODE:
          V1Node v1Node =
              coreV1Api.createNode(
                  K8sUtils.toObject(k8SYamlDTO.getO(), V1Node.class), CreateParam.pretty, CreateParam.dryRun, CreateParam.fieldManager);
          if (v1Node != null) {
            return true;
          }
          break;
      ...
      try {
        switch (enumByType) {
          case REPLICA_SET:
            ...
            v1Scale = v1beta1Api.readNamespacedReplicaSetScale(deploymentName, namespace, ReadParam.pretty);
            
            v1Scale.getSpec().setReplicas(modulePodSize);
            replaceReplicas = v1beta1Api.replaceNamespacedReplicaSetScale(deploymentName,
                namespace, v1Scale, ReplaceParam.pretty, ReplaceParam.dryRun, ReplaceParam.fieldManager).getSpec().getReplicas();
            break;
          
          case REPLICATION_CONTROLLER:
            v1Scale = coreV1Api.readNamespacedReplicationControllerScale(deploymentName, namespace, ReadParam.pretty);
            
            v1Scale.getSpec().setReplicas(modulePodSize);
            replaceReplicas = coreV1Api.replaceNamespacedReplicationControllerScale(deploymentName, namespace, v1Scale, ReplaceParam.pretty, ReplaceParam.dryRun, ReplaceParam.fieldManager).getSpec().getReplicas();
            break;
          case DEPLOYMENT:
            v1Scale = v1beta1Api.readNamespacedDeploymentScale(deploymentName, namespace, ReadParam.pretty);
            ...
            break;
          case STATEFUL_SET:
            v1Scale = appsV1Api.readNamespacedStatefulSetScale(deploymentName, namespace, ReadParam.pretty);
        ...
        throw new ServiceException(ResultCode.RESOURCE_SCALE_FAIL);
      }
    }
        ...
        try {
          ...
          switch (enumByType) {
            case NAMESPACE:
              ...
              call = coreV1Api.deleteNamespaceCall(sourceName, DeleteParam.pretty, DeleteParam.dryRun, DeleteParam.gracePeriodSeconds, DeleteParam.orphanDependents, DeleteParam.propagationPolicy, v1DeleteOptions, null);
            ...
            case REPLICATION_CONTROLLER:
              call = coreV1Api.deleteNamespacedReplicationControllerCall(sourceName,
                  namespace,
                  DeleteParam.pretty, DeleteParam.dryRun, DeleteParam.gracePeriodSeconds, DeleteParam.orphanDependents, DeleteParam.propagationPolicy, v1DeleteOptions, null);
              break;
            case INGRESS:
            ...
            case JOB:
              ...
              break;
            case ROLE:
              call = rbacAuthorizationV1Api.deleteNamespacedRoleCall(sourceName, namespace, DeleteParam.pretty, DeleteParam.dryRun, DeleteParam.gracePeriodSeconds, DeleteParam.orphanDependents, DeleteParam.propagationPolicy, v1DeleteOptions, null);
              break;
            case CLUSTER_ROLE:
              call = rbacAuthorizationV1Api.deleteClusterRoleCall(sourceName, DeleteParam.pretty, DeleteParam.dryRun, DeleteParam.gracePeriodSeconds, DeleteParam.orphanDependents, DeleteParam.propagationPolicy, v1DeleteOptions, null);
              break;
            case SECRET:
            ...
            case PERSISTENT_VOLUME:
              call = coreV1Api.deletePersistentVolumeCall(sourceName, DeleteParam.pretty, DeleteParam.dryRun, DeleteParam.gracePeriodSeconds, DeleteParam.orphanDependents, DeleteParam.propagationPolicy, v1DeleteOptions, null);
              break;
            case CRON_JOB:
            ...
            case CUSTOM_RESOURCE_DEFINITION:
              ...
              call = apiextensionsV1beta1Api.deleteCustomResourceDefinitionCall(sourceName, DeleteParam.pretty, DeleteParam.dryRun, DeleteParam.gracePeriodSeconds, DeleteParam.orphanDependents, DeleteParam.propagationPolicy, v1DeleteOptions, null);
              break;
            case STORAGE_CLASS:
              StorageV1Api storageV1Api = k8sApi.getStorageV1Api();
              call = storageV1Api.deleteStorageClassCall(sourceName, DeleteParam.pretty, DeleteParam.dryRun, DeleteParam.gracePeriodSeconds, DeleteParam.orphanDependents, DeleteParam.propagationPolicy, v1DeleteOptions, null);
              break;
            case PERSISTENT_VOLUME_CLAIM:
            ...
            case SERVICE_ACCOUNT:
              ...
              break;
            case CLUSTER_ROLE_BINDING:
              call = rbacAuthorizationV1Api.deleteClusterRoleBindingCall(sourceName, DeleteParam.pretty, DeleteParam.dryRun, DeleteParam.gracePeriodSeconds, DeleteParam.orphanDependents, DeleteParam.propagationPolicy, v1DeleteOptions, null);
              break;
            default:
              break;
          }
          ...
          throw new ServiceException(ResultCode.RESOURCE_DELETE_FAIL);
        } catch (IOException e) {
          throw new ServiceException(ResultCode.RESOURCE_DELETE_FAIL);
        }
      }
        ...
        if (enumByType != null) {
          ...
          switch (enumByType) {
            case NAMESPACE:
              ...
              call = coreV1Api.readNamespaceCall(resourceName, ReadParam.pretty, ReadParam.exact, ReadParam.export, null);
              
              break;
            case DEPLOYMENT:
              
              call = appsV1Api.readNamespacedDeploymentCall(resourceName, namespace, ReadParam.pretty, ReadParam.exact, ReadParam.export, null);
              
              break;
            case POD:
              call = coreV1Api.readNamespacedPodCall(resourceName, namespace, ReadParam.pretty, ReadParam.exact, ReadParam.export, null);
              break;
            case SERVICE:
              call = coreV1Api.readNamespacedServiceCall(resourceName, namespace, ReadParam.pretty, ReadParam.exact, ReadParam.export, null);
              break;
            case DAEMON_SET:
              
              call = appsV1Api.readNamespacedDaemonSetCall(resourceName, namespace, ReadParam.pretty, ReadParam.exact, ReadParam.export, null);
              break;
            case REPLICA_SET:
              call = appsV1Api.readNamespacedReplicaSetCall(resourceName, namespace, ReadParam.pretty, ReadParam.exact, ReadParam.export, null);
              break;
            case REPLICATION_CONTROLLER:
              call = coreV1Api.readNamespacedReplicationControllerCall(resourceName, namespace, ReadParam.pretty, ReadParam.exact, ReadParam.export, null);
              break;
            case INGRESS:
              call = extensionsV1beta1Api.readNamespacedIngressCall(resourceName, namespace, ReadParam.pretty, ReadParam.exact, ReadParam.export, null);
              break;
            case CONFIG_MAP:
              call = coreV1Api.readNamespacedConfigMapCall(resourceName, namespace, ReadParam.pretty, ReadParam.exact, ReadParam.export, null);
              break;
            case NODE:
              call = coreV1Api.readNodeCall(resourceName, ReadParam.pretty, ReadParam.exact, ReadParam.export, null);
              
              break;
            case STATEFUL_SET:
              call = appsV1Api.readNamespacedStatefulSetCall(resourceName, namespace, ReadParam.pretty, ReadParam.exact, ReadParam.export, null);
              
              break;
            case ENDPOINTS:
              call = coreV1Api.readNamespacedEndpointsCall(resourceName, namespace, ReadParam.pretty, ReadParam.exact, ReadParam.export, null);
              break;
            case JOB:
              
              call = batchV1Api.readNamespacedJobCall(resourceName, namespace, ReadParam.pretty, ReadParam.exact, ReadParam.export, null);
              break;
            case ROLE:
              
              call = rbacAuthorizationV1Api.readNamespacedRoleCall(resourceName, namespace, ReadParam.pretty, null);
              
              break;
            case CLUSTER_ROLE:
              call = rbacAuthorizationV1Api.readClusterRoleCall(resourceName, ReadParam.pretty, null);
              break;
            case SECRET:
              call = coreV1Api.readNamespacedSecretCall(resourceName, namespace, ReadParam.pretty, ReadParam.exact, ReadParam.export, null);
              break;
            case PERSISTENT_VOLUME:
              call = coreV1Api.readPersistentVolumeCall(resourceName, ReadParam.pretty, ReadParam.exact, ReadParam.export, null);
              break;
            case CRON_JOB:
              call = batchV1beta1Api.readNamespacedCronJobCall(resourceName, namespace, ReadParam.pretty, ReadParam.exact, ReadParam.export, null);
              break;
            case CUSTOM_RESOURCE_DEFINITION:
              call = apiextensionsV1Api.readCustomResourceDefinitionCall(resourceName, ReadParam.pretty, ReadParam.exact, ReadParam.export, null);
              break;
            case STORAGE_CLASS:
              call = storageV1Api.readStorageClassCall(resourceName, ReadParam.pretty, ReadParam.exact, ReadParam.export, null);
              break;
            case PERSISTENT_VOLUME_CLAIM:
              call = coreV1Api.readNamespacedPersistentVolumeClaimCall(resourceName, namespace, ReadParam.pretty, ReadParam.exact, ReadParam.export, null);
              break;
            case SERVICE_ACCOUNT:
              call = coreV1Api.readNamespacedServiceAccountCall(resourceName, namespace, ReadParam.pretty, ReadParam.exact, ReadParam.export, null);
              break;
            case CLUSTER_ROLE_BINDING:
              call = rbacAuthorizationV1Api.readClusterRoleBindingCall(resourceName, ReadParam.pretty, null);
              break;
            default:
              break;
          }
  ...
  public void updateResource(K8sYamlDTO k8SYamlDTO) {
    ...
    if (StringUtils.isNotBlank(kind) && StringUtils.isNotBlank(name)) {
      ...
      try {
        if (enumByType != null) {
          switch (enumByType) {
            case NAMESPACE:
              ...
              coreV1Api.replaceNamespace(name, K8sUtils.toObject(obj, V1Namespace.class), ReplaceParam.pretty, ReplaceParam.dryRun, ReplaceParam.fieldManager);
              
              return;
            case DEPLOYMENT: //部署
              
              appsV1Api.replaceNamespacedDeployment(name, nameSpace, K8sUtils.toObject(obj, V1Deployment.class), ReplaceParam.pretty, ReplaceParam.dryRun, ReplaceParam.fieldManager);
              return;
            case POD://Pod
              coreV1Api.replaceNamespacedPod(name, nameSpace, K8sUtils.toObject(obj, V1Pod.class), ReplaceParam.pretty, ReplaceParam.dryRun, ReplaceParam.fieldManager);
              return;
            case SERVICE:  //服务
              coreV1Api.replaceNamespacedService(name, nameSpace, K8sUtils.toObject(obj, V1Service.class), ReplaceParam.pretty, ReplaceParam.dryRun, ReplaceParam.fieldManager);
              return;
            case DAEMON_SET://守护进程集
              
              appsV1Api.replaceNamespacedDaemonSet(name, nameSpace, K8sUtils.toObject(obj, V1DaemonSet.class), ReplaceParam.pretty, ReplaceParam.dryRun, ReplaceParam.fieldManager);
              return;
            case REPLICA_SET: //副本集
              
              appsV1Api.replaceNamespacedReplicaSet(name, nameSpace, K8sUtils.toObject(obj, V1ReplicaSet.class), ReplaceParam.pretty, ReplaceParam.dryRun, ReplaceParam.fieldManager);
              return;
            case REPLICATION_CONTROLLER://副本控制器
              coreV1Api.replaceNamespacedReplicationController(name, nameSpace, K8sUtils.toObject(obj, V1ReplicationController.class), ReplaceParam.pretty, ReplaceParam.dryRun, ReplaceParam.fieldManager);
              
              return;
            
            case INGRESS://访问权
              extensionsV1beta1Api.replaceNamespacedIngress(name, nameSpace, K8sUtils.toObject(obj, ExtensionsV1beta1Ingress.class), ReplaceParam.pretty, ReplaceParam.dryRun, ReplaceParam.fieldManager);
              return;
            case CONFIG_MAP://配置字典
              coreV1Api.replaceNamespacedConfigMap(name, nameSpace, K8sUtils.toObject(obj, V1ConfigMap.class), ReplaceParam.pretty, ReplaceParam.dryRun, ReplaceParam.fieldManager);
              return;
            
            case NODE://节点
              coreV1Api.replaceNode(name, K8sUtils.toObject(obj, V1Node.class), ReplaceParam.pretty, ReplaceParam.dryRun, ReplaceParam.fieldManager);
              return;
            case STATEFUL_SET://有状态应用副本集
              
              appsV1Api.replaceNamespacedStatefulSet(name, nameSpace, K8sUtils.toObject(obj, V1StatefulSet.class), ReplaceParam.pretty, ReplaceParam.dryRun, ReplaceParam.fieldManager);
              return;
            
            case ENDPOINTS:
              coreV1Api.replaceNamespacedEndpoints(name, nameSpace, K8sUtils.toObject(obj, V1Endpoints.class), ReplaceParam.pretty, ReplaceParam.dryRun, ReplaceParam.fieldManager);
              return;
            case JOB: //任务
              batchV1Api.replaceNamespacedJob(name, nameSpace, K8sUtils.toObject(obj, V1Job.class), ReplaceParam.pretty, ReplaceParam.dryRun, ReplaceParam.fieldManager);
              return;
            case ROLE://角色
              rbacAuthorizationV1Api.replaceNamespacedRole(name, nameSpace, K8sUtils.toObject(obj, V1Role.class), ReplaceParam.pretty, ReplaceParam.dryRun, ReplaceParam.fieldManager);
              return;
            case CLUSTER_ROLE://集群角色
              rbacAuthorizationV1Api.replaceClusterRole(name, K8sUtils.toObject(obj, V1ClusterRole.class), ReplaceParam.pretty, ReplaceParam.dryRun, ReplaceParam.fieldManager);
              return;
            case SECRET://保密字典
              coreV1Api.replaceNamespacedSecret(name, nameSpace, K8sUtils.toObject(obj, V1Secret.class), ReplaceParam.pretty, ReplaceParam.dryRun, ReplaceParam.fieldManager);
              return;
            
            case PERSISTENT_VOLUME://持久化存储卷
              coreV1Api.replacePersistentVolume(name, K8sUtils.toObject(obj, V1PersistentVolume.class), ReplaceParam.pretty, ReplaceParam.dryRun, ReplaceParam.fieldManager);
              return;
            case CRON_JOB:
              batchV1beta1Api.replaceNamespacedCronJob(name, nameSpace, K8sUtils.toObject(obj, V1beta1CronJob.class), ReplaceParam.pretty, ReplaceParam.dryRun, ReplaceParam.fieldManager);
              return;
            
            case CUSTOM_RESOURCE_DEFINITION://自定义资源
              v1beta1Api.replaceCustomResourceDefinition(name, K8sUtils.toObject(obj, V1beta1CustomResourceDefinition.class), ReplaceParam.pretty, ReplaceParam.dryRun, ReplaceParam.fieldManager);
              return;
            
            case STORAGE_CLASS:
              storageV1Api.replaceStorageClass(name, K8sUtils.toObject(obj, V1StorageClass.class), ReplaceParam.pretty, ReplaceParam.dryRun, ReplaceParam.fieldManager);
              return;
            case PERSISTENT_VOLUME_CLAIM:
              coreV1Api.replaceNamespacedPersistentVolumeClaim(name, nameSpace, K8sUtils.toObject(obj, V1PersistentVolumeClaim.class), ReplaceParam.pretty, ReplaceParam.dryRun, ReplaceParam.fieldManager);
              return;
            case SERVICE_ACCOUNT:
              coreV1Api.replaceNamespacedServiceAccount(name, nameSpace, K8sUtils.toObject(obj, V1ServiceAccount.class), ReplaceParam.pretty, ReplaceParam.dryRun, ReplaceParam.fieldManager);
              return;
            case CLUSTER_ROLE_BINDING:
              rbacAuthorizationV1Api.replaceClusterRoleBinding(name, K8sUtils.toObject(obj, V1ClusterRoleBinding.class), ReplaceParam.pretty, ReplaceParam.dryRun, ReplaceParam.fieldManager);
              return;
            default:
              return;
          }
        ...
        throw new ServiceException(ResultCode.RESOURCE_UPDATE_FAIL);
      }
    }
  }
//
